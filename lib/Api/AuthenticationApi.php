...
class AuthenticationApi
{
     ...
     * Access Token
     *
     * @param  \Swagger\Client\Model\GetTokenRequest $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\GetTokenResponse
     */
     ...
     * Access Token
     *
     * @param  \Swagger\Client\Model\GetTokenRequest $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\GetTokenResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTokenWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\GetTokenResponse';
    ...
    protected function getTokenRequest($body)
    {
        ...
        $resourcePath = '/v1/external/auth/login';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
