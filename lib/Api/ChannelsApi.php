...
class ChannelsApi
{
     ...
     * @return \Swagger\Client\Model\ChannelsRequest
     */
    public function getAll2()
    {
        list($response) = $this->getAll2WithHttpInfo();
        return $response;
    }

    /**
     * Operation getAll2WithHttpInfo
     *
     * Get all channels
     *
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ChannelsRequest, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAll2WithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\ChannelsRequest';
        $request = $this->getAll2Request();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ChannelsRequest',
     ...
     */
    public function getAll2Async()
    {
        return $this->getAll2AsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAll2AsyncWithHttpInfo
     *
     * Get all channels
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAll2AsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\ChannelsRequest';
        $request = $this->getAll2Request();
    ...
    /**
     * Create request for operation 'getAll2'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAll2Request()
    {

        $resourcePath = '/v1/external/channels';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
