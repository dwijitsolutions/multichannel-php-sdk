...
class CountriesApi
{
    ...
    protected function getCountriesRequest()
    {
        ...
        $resourcePath = '/v1/external/countries';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Get all zones
     *
     * @param  int $id The specific id of the country in integer format (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\GetZonesResponse
     */
    public function getZones($id)
    {
        list($response) = $this->getZonesWithHttpInfo($id);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\GetZonesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getZonesWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\GetZonesResponse';
        $request = $this->getZonesRequest($id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\GetZonesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getZonesAsync($id)
    {
        return $this->getZonesAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getZonesAsyncWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\GetZonesResponse';
        $request = $this->getZonesRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getZonesRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getZones'
            );
        }

        $resourcePath = '/v1/external/countries/show/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
