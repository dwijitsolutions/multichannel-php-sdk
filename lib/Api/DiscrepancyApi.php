...
/**
 * DiscrepancyApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class DiscrepancyApi
{
     ...
     * @return \Swagger\Client\Model\DiscrepancyResponse
     */
    public function discrepancy()
    {
        list($response) = $this->discrepancyWithHttpInfo();
        return $response;
    }

    /**
     * Operation discrepancyWithHttpInfo
     *
     * Get discrepancy Details
     *
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DiscrepancyResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function discrepancyWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\DiscrepancyResponse';
        $request = $this->discrepancyRequest();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\DiscrepancyResponse',
     ...
     */
    public function discrepancyAsync()
    {
        return $this->discrepancyAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation discrepancyAsyncWithHttpInfo
     *
     * Get discrepancy Details
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function discrepancyAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\DiscrepancyResponse';
        $request = $this->discrepancyRequest();
    ...
    /**
     * Create request for operation 'discrepancy'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function discrepancyRequest()
    {

        $resourcePath = '/v1/external/billing/discrepancy';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
