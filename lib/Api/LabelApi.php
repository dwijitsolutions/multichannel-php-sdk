...
class LabelApi
{
     ...
     * Generate Label
     *
     * @param  \Swagger\Client\Model\GenerateLabelRequest $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\GenerateLabelResponse
     */
    public function generateLabel($body)
    {
        list($response) = $this->generateLabelWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation generateLabelWithHttpInfo
     *
     * Generate Label
     *
     * @param  \Swagger\Client\Model\GenerateLabelRequest $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\GenerateLabelResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function generateLabelWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\GenerateLabelResponse';
        $request = $this->generateLabelRequest($body);
     ...
     */
    public function generateLabelAsync($body)
    {
        return $this->generateLabelAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation generateLabelAsyncWithHttpInfo
     *
     * Generate Label
     *
     * @param  \Swagger\Client\Model\GenerateLabelRequest $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateLabelAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\GenerateLabelResponse';
        $request = $this->generateLabelRequest($body);
    ...
    /**
     * Create request for operation 'generateLabel'
     *
     * @param  \Swagger\Client\Model\GenerateLabelRequest $body (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function generateLabelRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling generateLabel'
            );
        }

        $resourcePath = '/v1/external/courier/generate/label';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
