 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AwbError500 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AwbError500';
     ...
     *
     * @param string $awb_assign_status Status if the code has been generated or not. In this case it would be a 0
     *
     * @return $this
     */
     ...
     * Sets data
     *
     * @param string $data Passes a statement saying it is not possible
     *
     * @return $this
     */
