...
/**
 * AwbTrackingRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AwbTrackingRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AwbTrackingRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['awb_code'] === null) {
            $invalidProperties[] = "'awb_code' can't be null";
        }
