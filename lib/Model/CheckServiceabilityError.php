...
/**
 * CheckServiceabilityError Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CheckServiceabilityError implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CheckServiceabilityError';
     ...
     * Sets message
     *
     * @param string $message Postcode is not secviceable by SHIPROCKET
     *
     * @return $this
     */
     ...
     * Sets status_code
     *
     * @param string $status_code HTTP status of request
     *
     * @return $this
     */
