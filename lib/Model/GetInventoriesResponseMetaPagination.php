...
/**
 * GetInventoriesResponseMetaPagination Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetInventoriesResponseMetaPagination implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetInventoriesResponse_meta_pagination';
     ...
     * Sets total
     *
     * @param int $total Shows the total number of products whose inventories were checked in the paginated page
     *
     * @return $this
     */
     ...
     * Sets count
     *
     * @param int $count Show the results for that paginated page
     *
     * @return $this
     */
     ...
     * Sets per_page
     *
     * @param int $per_page Shows the number of products which are listd per page
     *
     * @return $this
     */
     ...
     * Sets current_page
     *
     * @param int $current_page Shows the current page of the total number of pages
     *
     * @return $this
     */
     ...
     * Sets total_pages
     *
     * @param int $total_pages Shows the total number of pages
     *
     * @return $this
     */
     ...
     * Sets links
     *
     * @param string[] $links Lists the links to the inventories
     *
     * @return $this
     */
