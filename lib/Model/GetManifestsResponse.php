...
/**
 * GetManifestsResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetManifestsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetManifestsResponse';
     ...
     * Sets data
     *
     * @param string[] $data Displays the url of a pdf file with the manifest
     *
     * @return $this
     */
