...
/**
 * ShipmentTrackingResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShipmentTrackingResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShipmentTrackingResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tracking_data'] === null) {
            $invalidProperties[] = "'tracking_data' can't be null";
        }
     ...
     * Sets tracking_data
     *
     * @param object $tracking_data tracking_data
     *
     * @return $this
     */
